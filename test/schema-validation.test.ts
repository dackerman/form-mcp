...
describe('Schema Validation', () => {
  it('should confirm tool schemas are properly exposed', async () => {
    ...
    expect(createFormSchema.properties.schema.properties.fields.type).toBe('array');
    ...
    expect(getResponsesSchema.properties.schema.properties.formId).toBeDefined();
    expect(getResponsesSchema.properties.schema.properties.formId.type).toBe('string');
